Overview
--------
For now the library is still tiny. Functionality gets added or refined as needed, as of yet
we have basically just the caching and concurrency helper decorators.
